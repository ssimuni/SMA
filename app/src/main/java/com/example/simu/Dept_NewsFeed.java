...
public class Dept_NewsFeed extends AppCompatActivity {
    ...
    private Map<String, NewsFeed.User> userMap;
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        mUp_post.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Dept_NewsFeed.this, Upload_dept_post.class));
            }
        });
        setSpinnerListeners();
    }
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful() && task.getResult() != null) {
                            for (DocumentSnapshot document : task.getResult()) {
                                ...
                                NewsFeed.User user = new NewsFeed.User(userId, name, designation, workstation, division, district, upozila);
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        for (DocumentSnapshot ds : dslist) {
                            ...
                            NewsFeed.User user = userMap.get(userId);
        ...
        FirebaseFirestore.getInstance()
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        if (userProfileImage != null) {
                            Glide.with(Dept_NewsFeed.this).load(userProfileImage).into(newsfeedDp);
                        }
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Dept_NewsFeed.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void loadPosts() {
        ...
        FirebaseFirestore.getInstance()
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    @Override
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        String userDepartment = documentSnapshot.getString("department");
                        ...
                        if (userDepartment != null) {
                            ...
                            Toast.makeText(Dept_NewsFeed.this, "User department not found", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
